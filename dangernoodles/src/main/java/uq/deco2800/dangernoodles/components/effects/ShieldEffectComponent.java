 ...
 * <p>
 * This class is used to represent a shield effect.
 */
public class ShieldEffectComponent extends EffectComponent {
     ...
     */
    public ShieldEffectComponent(EffectEnum name,
                                 int turnDuration,
                                 double value) {
        if (name == null) {
    ...
    /**
     * Return the shield addition of this effect.
     *
     * @return a double representing the shield addition of this effect
     *
     * @ensure a double representing the shield addition of this effect
     */
    ...
    /**
     * Set the shield addition of this effect.
     *
     * @param value
     *         a double representing the shield addition of this effect
     *
     * @throws IllegalArgumentException
    ...
    public String toString() {
        return "Current effect gives shield of " + shieldValue + ".";
    }
    ...
    public boolean equals(Object obj) {
        ...
        } else if (!(obj instanceof ShieldEffectComponent)) {
            return false;
        } else {
            ShieldEffectComponent converted = (ShieldEffectComponent) obj;
            BigDecimal preciseEffect = BigDecimal.valueOf(shieldValue);
            BigDecimal preciseConverted = BigDecimal.valueOf(converted.shieldValue);
